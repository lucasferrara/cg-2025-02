...
function mainCar() {
    ...
    // corpo
    let vertices = rectangleVertices(-0.4, -0.1, 0.8, 0.25);
    ...
    // teto
    vertices = rectangleVertices(-0.3, 0.15, 0.5, 0.2);
    ...
    // parabrisa
    vertices = rectangleVertices(-0.2, 0.2, 0.3, 0.1);
    ...
    // roda esquerda
    const numSides = 16;
    vertices = circleVerticesCar(-0.25, -0.25, 0.1, numSides);
